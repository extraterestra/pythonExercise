...
test_rows_count = cursor.execute('''SELECT COUNT(*) FROM test''').fetchall()
print('Rows count test')
print(test_rows_count)
#
train_rows_count = cursor.execute('''SELECT COUNT(*) FROM train''').fetchall()
print('Rows count train')
print(train_rows_count)

ideal_rows_count = cursor.execute('''SELECT COUNT(*) FROM ideal''').fetchall()
print('Rows count ideal')
print(ideal_rows_count)

test_df = pd.read_sql('''SELECT * FROM test''', conn)
print('Data from df test')
print(test_df)
#
train_df = pd.read_sql('''SELECT * FROM train''', conn)
print('Data from df train')
print(train_df)

ideal_df = pd.read_sql('''SELECT * FROM ideal''', conn)
print('Data from df ideal')
print(ideal_df)
...
column_x_data_series = test_df['x']
column_y_data_series = test_df['y']
